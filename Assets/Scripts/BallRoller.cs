...
public class BallRoller : MonoBehaviour
{
    ...
    /** 
     * I changed the Update into a FixedUpdate. Since the movement of the ball involves
     * a calculation of the rigidbody physics, it is better to use FixedUpdate, that instead
     * of Update that gets executed every frame (therefore depends on the device performances),
     * it gets called every fixed amount of time.
     */
